...
public class FstTest extends BaseIntegrationTest {
    ...
    public void getUserByIdTest() {
        ...
        userRepresentation.setFirstName("pashok");
        userRepresentation.setLastName("pashok");
        userRepresentation.setEmail("pashok@mail.ru");
        ...
        MockHttpServletResponse response = mvc.perform(get("/api/users/" + testId))
                ...
                .andExpect(jsonPath("$.firstName").value("pashok"))
                .andReturn()
                .getResponse();
        assertEquals(HttpStatus.OK.value(), response.getStatus());
    }
